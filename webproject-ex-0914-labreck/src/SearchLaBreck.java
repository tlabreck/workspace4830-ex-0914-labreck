...
public class SearchLaBreck extends HttpServlet {
   ...
   void search(String keyword, HttpServletResponse response) throws IOException {
      ...
      try {
         ...
         if (keyword.isEmpty()) {
            String selectSQL = "SELECT * FROM MyTableLaBreck0914";
            preparedStatement = connection.prepareStatement(selectSQL);
         } else {
            String selectSQL = "SELECT * FROM MyTableLaBreck0914 WHERE EMAIL LIKE ?";
         ...
         out.println("<a href=/webproject-ex-0914-labreck/search_labreck.html>Search Data</a> <br>");
